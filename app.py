...
st.warning(
    "⚠️ ⚠️ Research Prototype: This AI classifier is designed for academic demonstration and research purposes. Predictions should not be considered a medical diagnosis or a substitute for professional medical advice.."
)
